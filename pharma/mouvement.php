...
<head>
	...
	<meta charset="utf8">
	<link rel="stylesheet" type="text/css" href="css/requet.css">
   ...
   <tr><td></td><td><input type="text" name="id" class="champ" size="25"  ></td></tr>
    <tr><td></td><td><strong >Code produit   </strong><select name="code" id="code" >
        ...
        <option  value="dlp">dlp</option>
		 ...
		 <option  value="pct">abc</option>
		 <option  value="pct">ab</option>
		 <option  value="pct">ac</option>
		 <option  value="pct">dolm</option>
     </select></td></tr>
